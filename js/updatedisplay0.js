...
Reveal.addEventListener( 'fragmentshown', function( event ) {
    ...
    if (classAttribute.indexOf("demo0-start") > -1) {
        setTimeout(displayData, delayTime, data_demo0_0, vis, h, scaleY);
    }
    else if (classAttribute.indexOf("demo0-git-story-1") > -1) {
        setTimeout(displayData, delayTime, data_demo0_1, vis, h, scaleY);
    }
    else if (classAttribute.indexOf("demo0-git-story-2") > -1) {
        setTimeout(displayData, delayTime, data_demo0_2, vis, h, scaleY);
    }
    else if (classAttribute.indexOf("demo0-git-story-3") > -1) {
        console.log(event.fragment.getAttribute("class"))
        setTimeout(displayData, delayTime, data_demo0_3, vis, h, scaleY);
    }
    else if (classAttribute.indexOf("demo0-git-delete-merge") > -1) {
        console.log(event.fragment.getAttribute("class"))
        setTimeout(displayData, delayTime, data_demo0_final, vis, h, scaleY);
    }
} );   
